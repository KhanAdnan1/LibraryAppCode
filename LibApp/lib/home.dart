...
class _Home extends State<Home>{
  ...
  Future<List<String>> fetchNoticeData() async {
    ...
    if (response.statusCode == 200) {
      ...
      final noticeList = data.map((item) => item['notices'].toString()).toList();
    ...
    body:ListView(
      children: [
        Container(
          ...
          margin: EdgeInsets.only(top:(MediaQuery.of(context).size.width/10),right:(MediaQuery.of(context).size.width/50),left:(MediaQuery.of(context).size.width/50)),
          ...
          child: Card(
            ...
            child:Padding(
              ...
              child: Column(
                children: [
                  Text("Welcome to  Libraray",style: TextStyle(fontSize:25, color: Colors.black,fontWeight: FontWeight.bold)),
        ...
        Container(
          margin: EdgeInsets.only(top: (MediaQuery.of(context).size.height/25),right: ((MediaQuery.of(context).size.width/50)),left: (MediaQuery.of(context).size.width/50)),
          child: Card(
            elevation: 8,
              ...
              children: <Widget>[
                ...
                CarouselSlider(
                    ...
                    return
                      Container(
                        child:Card(
                          ...
                          child:
                          Image.memory(
                              width:(MediaQuery.of(context).size.height/0.9), // Increase the width as needed
                  ...
                  options: CarouselOptions(
                    ...
                    aspectRatio: 0/0, // Adjust the aspect ratio as needed
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Container(
                        ...
                        child:Text('Check your internet connection ',style: TextStyle(fontSize:20, color: Colors.red,fontWeight: FontWeight.bold)) ,
                      );
                        // Handle errors here.
                    }else {
                      ...
                      if (noticeList.isEmpty) {
                        return Container(
                          margin: EdgeInsets.only(top:80),
                          child:Text('There is no notice',style: TextStyle(fontSize:25, color: Colors.red,fontWeight: FontWeight.bold)) ,
                        );
                              ...
                              children: noticeList.map((notice) {
                                return Container(
                                  ...
                                  child:Card(
                                    elevation:3,
                                    shadowColor: Colors.blue,
                                    child: Text(notice,style: TextStyle(fontSize:20 , color: Colors.red,fontWeight: FontWeight.bold)), // Display each notice.
                                  )
                                );
                              }).toList(),
                            ),
