      ...
      body: Novelspdf.isNotEmpty
        ...
        itemBuilder: (context, index) {
          ...
          return  Card(
            ...
            child:ListTile(
              title: Text(novels.title,style:TextStyle(color: Colors.white,fontSize: 18.0,fontWeight: FontWeight.bold)),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
...
class Novels{
  ...
  Novels({required this.title, required this.novelPdfData, required this.contentType});
}