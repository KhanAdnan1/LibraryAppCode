  ...
  Future<void> _fetchPdfBooks() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (final bookData in booksData) {
        ...
        books.add(Book(title: title, pdfData: pdfData, contentType: contentType));
      }
      setState(() {
        _pdfBooks = books;
      });
      ...
      body: _pdfBooks.isNotEmpty
        ...
        itemBuilder: (context, index) {
          ...
          return  Card(
            ...
            child:ListTile(
            title: Text(book.title,style:TextStyle(color: Colors.white,fontSize: 18.0,fontWeight: FontWeight.bold)),
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
